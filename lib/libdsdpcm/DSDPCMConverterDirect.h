...
template<typename real_t>
class DSDPCMConverterDirect_x1024 : public DSDPCMConverterDirect<real_t> {
...
public:
	void init(DSDPCMFilterSetup<real_t>& flt_setup, int dsd_samples) {
		DSDPCMConverter<real_t>::alloc_pcm_temp1(dsd_samples / 8);
		DSDPCMConverter<real_t>::alloc_pcm_temp2(dsd_samples / 16);
...
public:
	void init(DSDPCMFilterSetup<real_t>& flt_setup, int dsd_samples) {
		DSDPCMConverter<real_t>::alloc_pcm_temp1(dsd_samples / 4);
